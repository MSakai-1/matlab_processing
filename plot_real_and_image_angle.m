...
%radianをdegreeに変換
rosbag_sim.bag04_19_05_23_22.image_angle = ...
    rad2deg(rosbag_sim.bag04_19_05_23_22.image_angle);

rosbag_sim.bag04_19_05_23_22.real_angle = ...
    rad2deg(rosbag_sim.bag04_19_05_23_22.real_angle);
...
rosbag_sim.bag04_19_05_23_22.image_angle_filled = fillmissing(rosbag_sim.bag04_19_05_23_22.image_angle, 'linear');

for i = 1:num_rows_image-1
    if rosbag_sim.bag04_19_05_23_22.image_angle_filled(i+1) == rosbag_sim.bag04_19_05_23_22.image_angle_filled(i)
        rosbag_sim.bag04_19_05_23_22.image_angle_reprocess(i+1) = NaN;
    else
        rosbag_sim.bag04_19_05_23_22.image_angle_reprocess(i+1) = rosbag_sim.bag04_19_05_23_22.image_angle(i+1);
    end
end
...
rosbag_sim.bag04_19_05_23_22.real_angle_filled = fillmissing(rosbag_sim.bag04_19_05_23_22.real_angle, 'linear');

for i = 1:num_rows_real-1
    if rosbag_sim.bag04_19_05_23_22.real_angle_filled(i+1) == rosbag_sim.bag04_19_05_23_22.real_angle_filled(i)
        rosbag_sim.bag04_19_05_23_22.real_angle_reprocess(i+1) = NaN;
    else
        rosbag_sim.bag04_19_05_23_22.real_angle_reprocess(i+1) = rosbag_sim.bag04_19_05_23_22.real_angle(i+1);
    end
end
nnan_idx = ~isnan(rosbag_sim.bag04_19_05_23_22.real_angle_reprocess);
...
plot(rosbag_sim.bag04_19_05_23_22.ElapsedTime(nnan_idx) -offset, rosbag_sim.bag04_19_05_23_22.real_angle(nnan_idx), ".", 'MarkerSize', 10,  'Color', [0.8500 0.3250 0.0980]);
hold on;
%valid_idx = rosbag_sim.bag04_19_05_23_22.ElapsedTime > 5.03;
plot(rosbag_sim.bag04_19_05_23_22.ElapsedTime(valid_idx) -offset, rosbag_sim.bag04_19_05_23_22.image_angle(valid_idx), ".", 'MarkerSize', 10, 'Color', [0 0.4470 0.7410]);
xline(0, "--", 'LineWidth', 2, 'Color',	[1 0 0]);
xline(first_time -offset, "--", 'LineWidth', 2, 'Color',	[1 0 0]);
h3 = yline(0, 'LineWidth', 2, 'Color','k');
grid on;
